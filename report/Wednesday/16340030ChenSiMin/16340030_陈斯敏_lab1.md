...
* **利用xml代码编写进行design**：
  ...
  ![lab1-design](https://gitee.com/chensm9/PersonalProject1/report/Wednesday/16340030ChenSiMin/report-image/lab1-design.png)

* **在虚拟机上运行得到的结果截图**：
  
  ![lab1-VirtualDevice](https://gitee.com/chensm9/PersonalProject1/report/Wednesday/16340030ChenSiMin/report-image/lab1-VirtualDevice.png)
...
![lab1-ExampleEditText1](https://gitee.com/chensm9/PersonalProject1/report/Wednesday/16340030ChenSiMin/report-image/lab1-ExampleEditText1.png)
    
然而，layout_width只有两种选择，第一种是match_parent（老版本是fill_parent），会导致EditText占据整个宽度，包括按钮的那一部分，实现效果是这样的：

![lab1-ExampleEditText2](https://gitee.com/chensm9/PersonalProject1/report/Wednesday/16340030ChenSiMin/report-image/lab1-ExampleEditText2.png)

还有第二种选择，是wrap_content，会根据Text内容自适应宽度，默认情况下没办法占领满整个左区，实现结果是这样的：

![lab1-ExampleEditText3](https://gitee.com/chensm9/PersonalProject1/report/Wednesday/16340030ChenSiMin/report-image/lab1-ExampleEditText3.png)
